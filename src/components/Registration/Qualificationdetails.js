...
const Qualificationdetails = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Navigate to Previousprojects after submitting qualification details
    navigate('/previousprojects');
  };

  return (
    <Grid container justifyContent="center" alignItems="center" style={{ minHeight: '100vh' }}>
      <Grid item xs={12} sm={8} md={6}>
        <Box sx={{ p: 4, backgroundColor: '#f8f8f8', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)' }}>
